...
import pe.com.farmaciadey.metodopago.models.responses.DataResponse;
...
public class MetodoPagoController {
    ...
    public ResponseEntity<Object> save(@RequestBody Metodopago request) throws Exception {
    ...
    public ResponseEntity<Object> update(@PathVariable("id") Integer id, @RequestBody Metodopago request)
            throws Exception {
        DataResponse response = new DataResponse();
        try {
            if (id != request.getId()) {
