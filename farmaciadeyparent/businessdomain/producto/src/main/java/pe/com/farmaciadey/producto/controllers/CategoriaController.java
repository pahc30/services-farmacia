...
import pe.com.farmaciadey.producto.services.CategoriaService;
...
public class CategoriaController {
    ...
    public ResponseEntity<Object> save(@RequestBody Categoria request) throws Exception {
    ...
    public ResponseEntity<Object> update(@PathVariable("id") Integer id, @RequestBody Categoria request)
            throws Exception {
        DataResponse response = new DataResponse();
        try {
            if (id != request.getId()) {
